        ...
        while e > 0{
            ...
            if edge_vec[edge_nums[i] as usize] != 1 {
                ...
                let cond = match input.dist {
                    Some(DistKind::uniform) => (e as f64)/(m_e as f64),  
                    Some(DistKind::skewed) => (2.0 * e as f64)/(m_e as f64) - (2.0 * e as f64 * i as f64)/(m_e as f64*m_e as f64), 
                    Some(DistKind::sine) => (e as f64 / 4.0), 
                    None => 0.0, 
                }; 
                if y < cond 
                {
